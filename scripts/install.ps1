...
$extensionReleaseUrl = 'https://github.com/err0rgod/conduit-extension/releases/tag/v1.1.4'
$extensionArchiveUrl = 'https://github.com/err0rgod/conduit-extension/releases/download/v1.1.4/conduit-extension-unpacked-v1.1.4.zip'
